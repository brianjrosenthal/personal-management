  ...
  <form method="post" action="/admin/user_edit_eval.php" class="stack">
    ...
    <div class="grid" style="grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;">
      ...
      <label>Email
        ...
        <?php if (!$hasLogin): ?>
          <small class="small">Optional for family members without a login. Add an email to enable account activation.</small>
        <?php endif; ?>
      </label>
      ...
      <?php elseif (!$hasLogin): ?>
        <div class="small" style="color: #6c757d;">
          Admin status: No (family members without a login cannot be admins)
        </div>
      <?php else: ?>
        <div class="small" style="color: #6c757d;">
    ...
    <div class="grid" style="grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;">
      <div>
        ...
        <?php elseif (!$hasLogin && !$hasEmail): ?>
          <span class="small">No login (family member only)</span>
        <?php elseif (!$hasLogin): ?>
