...
// Settings definitions for the Family Office application
$SETTINGS_DEF = [
  'site_title' => [
    'label' => 'Site Title',
    'hint'  => 'Shown in the header and page titles. Defaults to "Family Office" if empty.',
    'type'  => 'text',
  ],
  'announcement' => [
    'label' => 'Announcement',
...
foreach ($SETTINGS_DEF as $key => $_meta) {
  ...
  if ($key === 'site_title') {
    $default = defined('APP_NAME') ? APP_NAME : 'Family Office';
  } elseif ($key === 'timezone') {
